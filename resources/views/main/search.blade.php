...
<div class="container mx-auto p-4">
    ...
    <form method="GET"
        ...
        <input name="search" type="text" value="{{ old('search', $search) }}"
        ...
        <button
            class="rounded lg:rounded-r-none px-4 py-2 w-full lg:w-auto
                   bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-600
                   dark:hover:bg-blue-500 transition-all">
            جستجو
        </button>
    </form>

    <h1 class="text-2xl font-semibold mb-4 text-center">نتایج جست‌وجو</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($results as $item)
                <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                    ...
                    @else
                        <div class="w-full h-48 bg-gray-300 dark:bg-gray-700 rounded mb-4 flex items-center justify-center">
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-2">
                        دسته‌بندی: {{ optional($item->categories->first())->name ?? 'بدون دسته' }}
                        | نوع: {{ $type_word }}
                    </div>
