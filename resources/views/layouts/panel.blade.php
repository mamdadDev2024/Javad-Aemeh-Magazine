...
<body class="transition-colors font-vasir flex flex-col bg-gradient-to-b dark:from-slate-700 from-slate-200 dark:to-slate-800 to-slate-300 min-h-screen">
    <x-admin_header id="header"/>
    @yield('body')
    <x-footer />
