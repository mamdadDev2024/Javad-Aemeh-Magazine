...
<div class="w-full fixed top-0 p-5 bg-blue-500 dark:bg-teal-700">
    ...
    <div class="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <form action="{{ route('do_forget') }}" method="POST" class="bg-slate-800 rounded-2xl shadow-xl w-full max-w-md p-6 space-y-6">
            @csrf
            <div>
            ...
            <x-captcha/>
            <button type="submit" class="w-full py-3 text-white font-semibold bg-gradient-to-r from-blue-900 to-amber-600 hover:from-blue-800 hover:to-amber-500 transition-colors rounded-xl">ارسال</button>
        </form>
    </div>
@endsection
